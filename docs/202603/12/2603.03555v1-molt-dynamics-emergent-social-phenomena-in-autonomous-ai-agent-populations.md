...
method: 在MoltBook平台上对9万多名活跃智能体进行为期三周的纵向观察，结合网络聚类、级联分析和协作任务评估进行研究。
result: "发现智能体自发形成核心-边缘结构，信息传播呈现幂律分布，但多智能体协作成功率仅为6.7%，表现弱于单智能体。"
conclusion: 研究确立了去中心化智能体系统的协调动力学基准，指出当前涌现的协作行为仍处于初级阶段，对未来系统设计具有指导意义。
---

## 摘要
MoltBook 是一个大规模多智能体协作环境，其中超过 770,000 个自主大语言模型（LLM）智能体在没有人类参与的情况下进行交互，这为我们提供了已知首个在此类群体规模下观察涌现的多智能体协作动力学的机会。我们引入了 \textit{Molt 动力学}：即当自主智能体在不受约束的多智能体环境中作为去中心化决策者运行时，所产生的涌现智能体协作行为、智能体间通信动力学以及
